...
const audioElement: HTMLAudioElement | null = document.querySelector("#trysong");
const audio: HTMLAudioElement | null = document.querySelector("#trysound");
const playBtn: HTMLImageElement | null = window.document.querySelector("#playbtn");
const pauseBtn: HTMLImageElement | null = window.document.querySelector("#pausebtn");
const repeatBtn: HTMLImageElement | null = window.document.querySelector("#repeatbtn");
const norepeatBtn: HTMLImageElement | null = window.document.querySelector("#norepeatbtn");
...
const repeatsong = () => {
    if (audioElement !== null) audioElement.loop = true;
    repeatBtn?.classList.add("on");
    norepeatBtn?.classList.add("on");
};
const unrepeatsong = () =>
{
    if (audioElement !== null) audioElement.loop = false;
