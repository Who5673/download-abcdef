...
const audio: HTMLAudioElement | null = document.querySelector("#trysong");
...
const rewindBtn: HTMLImageElement | null = window.document.querySelector("#rewindbtn");
